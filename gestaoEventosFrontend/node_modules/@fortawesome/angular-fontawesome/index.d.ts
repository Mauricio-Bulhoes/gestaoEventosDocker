...
declare class FaIconComponent {
     ...
     */
    readonly animation: _angular_core.ModelSignal<AnimationProp>;
    readonly mask: _angular_core.ModelSignal<IconProp>;
    readonly flip: _angular_core.ModelSignal<FlipProp>;
    readonly size: _angular_core.ModelSignal<SizeProp>;
    readonly pull: _angular_core.ModelSignal<PullProp>;
    readonly border: _angular_core.ModelSignal<boolean>;
    readonly inverse: _angular_core.ModelSignal<boolean>;
    readonly symbol: _angular_core.ModelSignal<FaSymbol>;
    readonly rotate: _angular_core.ModelSignal<string | RotateProp>;
    readonly fixedWidth: _angular_core.ModelSignal<boolean>;
    readonly transform: _angular_core.ModelSignal<string | Transform>;
    /**
     * Specify the `role` attribute for the rendered <svg> element.
     *
     * @default 'img'
     */
    readonly a11yRole: _angular_core.ModelSignal<string>;
...
declare class FaDuotoneIconComponent extends FaIconComponent {
     ...
     * @default false
     */
    readonly swapOpacity: _angular_core.InputSignal<boolean | "true" | "false">;
    /**
     ...
     * @default 1.0
     */
    readonly primaryOpacity: _angular_core.InputSignal<string | number>;
    /**
     ...
     * @default 0.4
     */
    readonly secondaryOpacity: _angular_core.InputSignal<string | number>;
    /**
     ...
     */
    readonly primaryColor: _angular_core.InputSignal<string>;
    /**
     ...
     * @default CSS inherited color
     */
    readonly secondaryColor: _angular_core.InputSignal<string>;
    protected findIconDefinition(i: IconProp | IconDefinition): IconDefinition$1 | null;
    protected buildParams(): IconParams;
...
declare class FaLayersComponent implements OnInit {
    readonly size: _angular_core.InputSignal<SizeProp>;
    readonly fixedWidth: _angular_core.InputSignal<boolean>;
    readonly faFw: _angular_core.Signal<boolean>;
...
declare class FaLayersTextComponent {
    ...
    readonly flip: _angular_core.InputSignal<FlipProp>;
    readonly size: _angular_core.InputSignal<SizeProp>;
    readonly pull: _angular_core.InputSignal<PullProp>;
    readonly border: _angular_core.InputSignal<boolean>;
    readonly inverse: _angular_core.InputSignal<boolean>;
    readonly rotate: _angular_core.InputSignal<string | RotateProp>;
    readonly fixedWidth: _angular_core.InputSignal<boolean>;
    readonly transform: _angular_core.InputSignal<string | Transform>;
...
declare class FaLayersCounterComponent {
    readonly content: _angular_core.InputSignal<string>;
    readonly title: _angular_core.InputSignal<string>;
    readonly position: _angular_core.InputSignal<"bottom-right" | "bottom-left" | "top-right" | "top-left">;
    readonly renderedHTML: _angular_core.Signal<_angular_platform_browser.SafeHtml>;
    private document;
    private config;
    private parent;
